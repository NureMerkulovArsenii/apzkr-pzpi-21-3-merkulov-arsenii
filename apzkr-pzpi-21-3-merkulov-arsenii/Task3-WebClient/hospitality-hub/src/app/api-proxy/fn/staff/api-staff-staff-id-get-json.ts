...
export function apiStaffStaffIdGet$Json(http: HttpClient, rootUrl: string, params: ApiStaffStaffIdGet$Json$Params, context?: HttpContext): Observable<StrictHttpResponse<StaffDetailedResponseDto>> {
